...
function updater(){
  var d = new Date();
  document.getElementById("lsdimage").innerHTML = '<a href="<?php echo $baseurl; ?>/site.phtml?station='+ selectedSite +'"><img src="<?php echo $baseurl; ?>static/radar/'+ selectedSite +'/'+ selectedSite +'_0.png?'+ d.getTime() +'" border="1" width="320" height="240" alt="Live Super Doppler" /></a><br />Click on map for more details.';
  document.getElementById("webcamimage").innerHTML = '<a href="<?php echo $baseurl; ?>/camera/"><img src="<?php echo $baseurl; ?>camera/stills/'+ eval("webcamlookup."+ selectedSite ) +'.jpg?'+ d.getTime() +'" border="1" width="320" height="240" alt="Webcam" /></a><br />Click on image for other cameras.';
