...
if ($status != 0) then 
  ...
  pqinsert -p "lsd ac ${YYYYMMDDHHMM} gis/images/26915/KCCI/KCCI_N0R_0.png GIS/kcci/KCCI_${YYYYMMDDHHMM}.png png" max2.png

  echo "`date -u +'%m/%d %H:%M'`" > gtime.txt
  pqinsert -p "data c ${YYYYMMDDHHMM} gis/images/26915/KCCI/KCCI_N0R_tm_0.txt bogus txt" gtime.txt
